...
function checkLevelUpRewards(level) {
    if (level === 2) {
        showLevelRewardModal(
            "🚀 특별 목표 알림 🚀",
            "Lv. 2 달성을 축하합니다!",
            "레벨 10이 되면 특급 윙어 <strong>'이승우'</strong>, 레벨 20이 되면 월드클래스 <strong>'손흥민'</strong>, 레벨 30이 되면 파리의 마술사 <strong>'이강인'</strong>, 레벨 40이 되면 태극전사 <strong>'이승우(스페셜)'</strong>, 레벨 50이 되면 영원한 산소탱크 <strong>'박지성'</strong>, 레벨 60이 되면 마스터 플레이메이커 <strong>'기성용'</strong>, 레벨 70이 되면 괴물 수비수 <strong>'김민재'</strong>, 레벨 80이 되면 중원의 열정 엔진 <strong>'이재성'</strong>, 레벨 90이 되면 왼발의 마술사 <strong>'이동경'</strong> 특별 카드, 레벨 110이 되면 대한민국의 핵심 사령탑 <strong>'황인범'</strong> 특별 카드, 레벨 120이 되면 대한민국 황소 <strong>'황희찬'</strong> 특별 카드, 레벨 130이 되면 대구 FC의 전설 <strong>'세징야'</strong> 특별 카드, 레벨 140이 되면 포항의 젊은 사자 <strong>'이동국99'</strong> 특별 카드가 지급되며, 레벨 150부터는 10레벨 달성 시마다 <strong>5 FP(포인트)</strong>를 받으실 수 있습니다!<br><br>열심히 단어 공부를 하고 특별한 혜택을 쟁취해보세요!"
        );
        ...
        if (cardId && typeof CARDS_DATABASE !== 'undefined' && CARDS_DATABASE[cardId]) {
            ...
            if (level === 140) {
                subText = "앞으로 레벨 150부터는 10레벨마다 5 FP가 지급됩니다!";
            }
            showLevelRewardModal(
                "🎁 특별 레벨업 보상 🎁",
                `Lv. ${level} 달성을 축하합니다!`,
