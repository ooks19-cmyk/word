...
| **[js/squad.js](file:///c:/Users/ooks1/OneDrive/바탕 화면/축구카드/js/squad.js)** | 4-2-3-1 포메이션의 중앙 공격형 미드필더(AM) 슬롯에 플레이어 네이티브 미드필더(CM) 및 윙어(LW/RW)를 모두 배치할 수 있도록 포지션 호환성 검증 알고리즘 개편 |
